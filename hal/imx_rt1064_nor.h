...
typedef struct _FlexSPIConfig
{
    ...
    uint8_t lutCustomSeqEnable;         /* [0x047-0x047] LUT customization Enable, it is required if the program/erase cannot be
                                            done using 1 LUT sequence, currently, only applicable to HyperFLASH */
