...
### V 2.5.0 - (2025-05-05)
  * New hardware targets
    ...
    * NXP MCXA153
    * NXP MCXW716
    * STM32F1 series (STM32F103 â€œBlue Pillâ€ board)
  * Improvements to supported targets
    * Xilinx UltraScale+ (ZynqMP)
        ...
        * Introduced support for the deviceâ€™s PUF (Physically Unclonable Function) for unique key generation and secure key storage (requires eFuses)
    * Renesas RX
