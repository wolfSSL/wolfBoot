...
#elif defined(TARGET_va416x0) /* For Vorago VA416xx */
    /* IRQ 0 through TXEV_IRQn (195), for 212 entries. wolfBoot points VTOR
     * at this table; see docs/Targets.md for the alignment it needs. */
    isr_empty,
    isr_empty,
    isr_empty,
    isr_empty,
...
/* 16 system exceptions + 196 external IRQs; see src/boot_arm.c. */
typedef char va416x0_app_iv_len_check[
