...
test-size-all:
	...
	make clean
	make test-size SIGN=ECC256 NO_ASM=1 LIMIT=13924 NO_ARM_ASM=1
	make keysclean
	...
	make clean
	make test-size SIGN=ECC384 NO_ASM=1 LIMIT=15284 NO_ARM_ASM=1
	make keysclean
	make test-size SIGN=ED448 LIMIT=14248 NO_ARM_ASM=1
	make keysclean
