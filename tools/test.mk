...
test-size-all:
	make test-size SIGN=NONE LIMIT=4944 NO_ARM_ASM=1
	make keysclean
	make test-size SIGN=ED25519 LIMIT=11616 NO_ARM_ASM=1
	make keysclean
	make test-size SIGN=ECC256  LIMIT=18944 NO_ARM_ASM=1
	make clean
	make test-size SIGN=ECC256 NO_ASM=1 LIMIT=13632 NO_ARM_ASM=1
	make keysclean
	make test-size SIGN=RSA2048 LIMIT=11408 NO_ARM_ASM=1
	make clean
	make test-size SIGN=RSA2048 NO_ASM=1 LIMIT=11968 NO_ARM_ASM=1
	make keysclean
	make test-size SIGN=RSA4096 LIMIT=11712 NO_ARM_ASM=1
	make clean
	make test-size SIGN=RSA4096 NO_ASM=1 LIMIT=12256 NO_ARM_ASM=1
	make keysclean
	make test-size SIGN=ECC384 LIMIT=19888 NO_ARM_ASM=1
	make clean
	make test-size SIGN=ECC384 NO_ASM=1 LIMIT=14992 NO_ARM_ASM=1
	make keysclean
	make test-size SIGN=ED448 LIMIT=13600 NO_ARM_ASM=1
	make keysclean
	make test-size SIGN=RSA3072 LIMIT=11552 NO_ARM_ASM=1
	make clean
	...
	make test-size SIGN=LMS LMS_LEVELS=2 LMS_HEIGHT=5 LMS_WINTERNITZ=8 \
		...
		IMAGE_HEADER_SIZE?=5288 LIMIT=7600 NO_ARM_ASM=1
	make keysclean
	make test-size SIGN=XMSS XMSS_PARAMS='XMSS-SHA2_10_256' \
		IMAGE_SIGNATURE_SIZE=2500 IMAGE_HEADER_SIZE?=4096 \
		LIMIT=8464 NO_ARM_ASM=1
	make keysclean
	make clean
	make test-size SIGN=ML_DSA ML_DSA_LEVEL=2 LIMIT=19296 \
