...
static void fsp_set_silicon_cfg(FSPS_UPD *fsps)
{
    ...
    upd->SerialIoUartDmaEnable[0] = 1;
    upd->SerialIoUartDmaEnable[1] = 1;
    upd->SerialIoUartDmaEnable[2] = 1;
    upd->SerialIoUartDmaEnable[3] = 1;
    upd->SerialIoUartDmaEnable[4] = 1;
    upd->SerialIoUartDmaEnable[5] = 1;
    upd->SerialIoUartDmaEnable[6] = 1;
    ...
    upd->PchProtectedRangeLimit[0] = 62992;
    ...
    upd->PchProtectedRangeBase[1] = 63057;
    ...
    upd->PcieRpL1Substates[0] = 1;
    upd->PcieRpL1Substates[1] = 1;
    upd->PcieRpL1Substates[2] = 1;
    upd->PcieRpL1Substates[3] = 1;
    upd->PcieRpL1Substates[4] = 1;
    upd->PcieRpL1Substates[5] = 1;
    upd->PcieRpL1Substates[6] = 1;
    upd->PcieRpL1Substates[7] = 1;
    upd->PcieRpL1Substates[8] = 1;
    upd->PcieRpL1Substates[9] = 1;
    upd->PcieRpL1Substates[10] = 1;
    upd->PcieRpL1Substates[11] = 1;
